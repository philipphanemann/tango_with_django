...
class GeneralTests(TestCase):
    def test_serving_static_files(self):
        # If using static media properly result is not NONE once it finds von_neumann_no_sense.jpg
        result = finders.find('images/von_neumann_no_sense.jpg')
...
class IndexPageTests(TestCase):
    ...
    def test_rango_picture_displayed(self):
        # Check if is there an image called 'von_neumann_no_sense.jpg' on the index page
        # Chapter 4
        response = self.client.get(reverse('index'))
        self.assertIn(b'img src="/static/images/e_pi_1_0.jpg', response.content)
